...
BUCKET_NAME = f"{PROJECT_ID}-dezoomcamp-hw3-2025"


# If you authenticated through the GCP SDK you can comment out these two lines
# Resolve the credentials file relative to this script's location so it works
# regardless of the current working directory.
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
CREDENTIALS_FILE = os.path.join(BASE_DIR, "keys", "my-creds.json")
...
CHUNK_SIZE = 8 * 1024 * 1024 # (8MB, standard chunk size for GCS Streaming I/O [8 * 1KB ^ 2 -> 8 * 1MB = 8MB])
